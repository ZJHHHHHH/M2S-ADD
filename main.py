...
#/your/path/to/protocols/ASVspoof_database/
    ...
    parser.add_argument('--loss', type=str, default='',help='Weighted Cross Entropy Loss ')

    # model
    parser.add_argument('--seed', type=int, default=, help='random seed (default: 1234)')
    ...
    model_save_path = os.path.join('', model_tag)
    ...
    writer = SummaryWriter('/sdc/home/zhangjinhua/M2S_interspeech/a_r_logs/{}'.format(model_tag))  
